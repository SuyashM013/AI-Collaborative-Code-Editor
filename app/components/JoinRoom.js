    ...
    return (
        <div className="bg-foreground w-screen min-h-screen ">
            ...
            <div className="h-screen w-screen absolute overflow-hidden z-1">
                <DarkVeil speed={1.8} warpAmount={1.5} scanlineIntensity={1} />
            </div>
            <div>
                <Header />
            ...
            <div className="absolute h-screen z-10 w-screen  flex flex-col items-center justify-center">
                ...
                <form className="text-white flex flex-col items-center  gap-6 p-8 rounded-xl shadow-2xl drop-shadow-lg shadow-sky-200/40 ring-1 ring-black/5 backdrop-blur-sm" onSubmit={handleRoomSubmit}>
                    <p className="w-full text-font" >Paste your invitation code down below</p>

                    <div className="w-full">
                        <input
                            className="w-full bg-accent/20 rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-sky-400 text-white joinBoxInput"
                            id="roomIdInput"
                            type="text"
